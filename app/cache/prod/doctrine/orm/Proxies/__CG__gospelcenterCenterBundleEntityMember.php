 ...
 */
class Member extends \gospelcenter\CenterBundle\Entity\Member implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setMemberFromDate($memberFromDate);
    }

    public function getMemberFromDate()
    {
        $this->__load();
        return parent::getMemberFromDate();
    }
    ...
    {
        return array('__isInitialized__', 'memberFromDate', 'person', 'centers');
    }
